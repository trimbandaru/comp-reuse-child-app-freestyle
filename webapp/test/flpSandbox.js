		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "childappfs",
									"targetURL": "#comtestchildappfs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestchildappfs-display": {
								"semanticObject": "comtestchildappfs",
								"action": "display",
								"description": "childappfs",
								"title": "childappfs",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.childappfs",
									"url": sap.ui.require.toUrl("com/test/childappfs")
								}
							}
						}
					}
